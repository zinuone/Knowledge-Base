...
/* ═══════════════════════════════════════════════════════════════
   ...
   Tujuan   : Menampilkan kalkulator Uang Jaminan Lelang (UJL),
              alur penyetoran resmi, dan referensi regulasi.
   ...
   Status   : Fitur simulasi edukasi (Sesuai Regulasi).
═══════════════════════════════════════════════════════════════ */
...
import {
    ...
    Calculator, ShieldCheck, BadgeCheck,
...
const SimulasiUJLPage: React.FC = () => {
    ...
    const steps = [
        ...
        },
        {
            ...
            label: 'Setor via Virtual Account',
            sub: 'Lakukan penyetoran UJL ke nomor Virtual Account (VA) resmi yang diterbitkan oleh sistem portal Lelang Indonesia.',
            color: 'from-blue-400 to-indigo-500',
        },
        {
            no: '04',
            icon: <BadgeCheck className="w-5 h-5" />,
            label: 'Verifikasi Sistem',
            sub: 'Sistem lelang akan memverifikasi penyetoran Anda secara otomatis sebelum pelaksanaan lelang dimulai.',
    ...
    return (
        ...
        >
            ...
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Hitung estimasi Uang Jaminan Lelang (UJL) Barang Milik Negara secara digital. Berdasarkan PMK 27/PMK.06/2016 Pasal 26 — KPKNL Kendari DJKN."
                />
                <meta name="keywords" content="UJL, Uang Jaminan Lelang, BMN, Lelang BMN, KPKNL Kendari, PMK 27 2016, DJKN" />
                <meta property="og:title" content="Simulasi UJL Lelang BMN — KPKNL Kendari" />
                <meta property="og:description" content="Kalkulator interaktif Uang Jaminan Lelang (UJL) BMN KPKNL Kendari." />
            </Helmet>
            ...
            <div className="relative bg-gradient-to-br from-[#0D5C35] via-[#0A492A] to-[#062B18] pt-12 pb-14 px-4 overflow-hidden">
                ...
                <div className="relative z-10 max-w-5xl mx-auto">
                    ...
                    <h1 className="ufu-2 text-3xl md:text-4xl font-black text-white tracking-tight mb-3 leading-tight">
                        ...
                        <span className="block text-[#D4AF37] mt-1">Sesuai Regulasi Berlaku</span>
                    </h1>
                    <p className="ufu-3 text-emerald-100/70 text-sm md:text-base leading-relaxed max-w-2xl mb-5">
                        ...
                        Negara secara mandiri untuk persiapan penyetoran melalui Virtual Account resmi KPKNL.
                    </p>
                    ...
                    <div className="section-fade flex flex-col">
                        <div className="mb-5">
                            <p className="text-[#0D5C35] dark:text-emerald-400 text-xs font-black uppercase tracking-widest mb-1">
                                Alur Pembayaran Resmi
                            </p>
                            <p className="text-slate-500 dark:text-slate-400 text-sm">
                                Ikuti 4 langkah berikut untuk memahami alur penyetoran UJL yang sesuai regulasi.
                            </p>
                        </div>
                        ...
                        <div className="mt-6 flex flex-wrap gap-2">
                            {[
                                { icon: <ShieldCheck className="w-3 h-3" />, label: 'Aman' },
                                { icon: <Landmark className="w-3 h-3" />, label: 'Sesuai Regulasi' },
                                { icon: <BadgeCheck className="w-3 h-3" />, label: 'Terverifikasi Sistem' },
                            ].map(c => (
                                <span
                                    key={c.label}
