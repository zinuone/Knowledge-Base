...
export const SkeletonCard = () => (
    <>
        <ShimmerStyle />
        <div className="bg-white p-7 rounded-2xl border border-slate-100 shadow-sm h-full flex flex-col gap-4">
    ...
    <>
        ...
        <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="bg-white rounded-3xl shadow-md border border-slate-100 overflow-hidden">
                {/* Header */}
                <div className="p-8 md:p-12 border-b border-slate-100 bg-gradient-to-br from-white via-slate-50 to-emerald-50/20">
